...
#
get_filename_component(filename "/home/malesko/dev/jitgl/build/_deps/text_editor-subbuild/text_editor-populate-prefix/src/master.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/malesko/dev/jitgl/build/_deps/text_editor-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-text_editor-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-text_editor-populate${i}")
